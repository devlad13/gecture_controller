...
#pragma warning restore IDE1006
    ...
    protected Bootstrap FindBootstrap()
    {
      ...
      //Logger.LogWarning(TAG, "Global Bootstrap instance is not found (maybe running a sample scene directly), "+ "so activating a fallback Bootstrap instance attached to each Solution object");
